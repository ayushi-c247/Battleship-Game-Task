const message = {
    ...
    USER_TWO_LOSS: "USER TWO YOU MISSED IT!!!",
    USER_ONE_LOSS: "USER ONE YOU MISSED IT!!!",
    ...
    INVAILID_COORDINATE: "invalid co-ordinates chosen for placing ship on game board",
}
