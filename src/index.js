...
const { displayGrid, createBoard } = require("./board");
const attack = require("./attack");
const getRandomInt = require("./getRandomValue");
const { placeCharacter, placeCharacterVertical } = require("./setShip");
...
while (enemyAttacks > 0 && userAttacks > 0) {
    ...
    if (userBoardSize > x && userBoardSize > y) {
        ...
        console.log("please select correct coordinaate");
    }
